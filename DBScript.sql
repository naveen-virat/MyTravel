...
INSERT INTO Hotel(HotelId,HotelName,HotelRating,SingleRoomPrice,DoubleRoomPrice,DeluxeeRoomPrice,[SuiteRoomPrice],City) VALUES(1000,'Adelaide Spcl',3,3200,5500,7800,9000,'Australia')
INSERT INTO Hotel(HotelId,HotelName,HotelRating,SingleRoomPrice,DoubleRoomPrice,DeluxeeRoomPrice,[SuiteRoomPrice],City) VALUES(1001,'Brisbane Heat',3,3200,5500,7800,9800,'Australia')
INSERT INTO Hotel(HotelId,HotelName,HotelRating,SingleRoomPrice,DoubleRoomPrice,DeluxeeRoomPrice,[SuiteRoomPrice],City) VALUES(1002,'Swosti Grand',4, 700,1400,2100,2800,'Ooty')
INSERT INTO Hotel(HotelId,HotelName,HotelRating,SingleRoomPrice,DoubleRoomPrice,DeluxeeRoomPrice,[SuiteRoomPrice],City) VALUES(1003,'Grand Hayat',3, 1400,2900,4800,5600,'Jaipur')
INSERT INTO Hotel(HotelId,HotelName,HotelRating,SingleRoomPrice,DoubleRoomPrice,DeluxeeRoomPrice,[SuiteRoomPrice],City) VALUES(1004,'Waterfront',3, 2800,4000,8800,9500,'America')
INSERT INTO Hotel(HotelId,HotelName,HotelRating,SingleRoomPrice,DoubleRoomPrice,DeluxeeRoomPrice,[SuiteRoomPrice],City) VALUES(1005,'Hotel Park View',4,3200,5500,7800,9200,'Australia')
INSERT INTO Hotel(HotelId,HotelName,HotelRating,SingleRoomPrice,DoubleRoomPrice,DeluxeeRoomPrice,[SuiteRoomPrice],City) VALUES(1006,'Cabbon Park',4,3200,5500,7800,9500,'Australia')
...
INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('Mayank@gmail.com',2457984315,'310-Lucknow','2024-12-20',2,0,'Booked',900)
INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('poorvi@gmail.com',8465713549,'253-Delhi','2024-04-12',3,0,'Booked',909)
INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('Prabhjeet@gmail.com',4587921568,'310-Agra','2024-05-09',2,1,'Booked',901)
INSERT INTO BookPackage(EmailId,ContactNumber,[Address],DateOfTravel,NumberOfAdults,NumberOfChildren,[Status],PackageId) VALUES('Sagar@gmail.com',3654789125,'310-pune','2024-09-07',2,0,'Booked',902)
...
[VehicleStatus] VARCHAR(30) CONSTRAINT chkStatus CHECK (VehicleStatus='Booked' OR VehicleStatus='Active' OR VehicleStatus='Closed')
)
