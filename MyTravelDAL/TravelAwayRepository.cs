...
namespace TravelAwayDAL
{
    ...
    {
        public TravelAwayDbContext Context;
        ...
        public List<Package>? GetPackages()
        {
            ...
            try
            {
                package = (from p in Context.Packages select p).ToList();
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
        ...
        public int BookPackageBySP(BookPackage bookpkg)
        {
            ...
            try
            {
                ...
                //Exec @BookingId1 = usp_BookPackage "Mayank@gmail.com",9999999999, "asadasdc","2024-09-09",2,1,"Booked",900, @BookingId2 out
        ...
        public string? GetCitiesByPackageDetailsId(int bookId)
        {
            ...
            try
            {
                pkgid = (from bookpackage in Context.BookPackages where bookpackage.BookingId == bookId select bookpackage.PackageId).FirstOrDefault();
